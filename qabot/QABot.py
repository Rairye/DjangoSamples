...
inventory_questions_lines = open('qabot_manager/InventoryQuestions.txt', encoding='utf-8')
general_questions_lines = open('qabot_manager/GeneralQuestions.txt', encoding='utf-8')
vocab_lines = open('qabot_manager/Vocab.txt', encoding='utf-8')
misc_questions_comments_lines = open('qabot_manager/MiscQuestionsComments.txt', encoding='utf-8')
