...
lines = pd.read_csv("chatbot_manager/simpsons_dataset.csv", encoding="utf-8")
...
def get_random():
	random_num = random.randint(0, len(inputs_outputs)-1)
	random_sent = list(inputs_outputs.values())[random_num]
	return random_sent
